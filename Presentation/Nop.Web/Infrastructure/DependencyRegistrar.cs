...
namespace Nop.Web.Infrastructure
{
    public class DependencyRegistrar : IDependencyRegistrar
    {
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder)
        {
            ...
            builder.RegisterType<LimousineBanVeService>().As<ILimousineBanVeService>().InstancePerLifetimeScope();
            builder.RegisterType<HopDongChuyenService>().As<IHopDongChuyenService>().InstancePerLifetimeScope();
            builder.RegisterType<ChiPhiXeVanChuyenService>().As <IChiPhiXeVanChuyenService>().InstancePerLifetimeScope();
        }
