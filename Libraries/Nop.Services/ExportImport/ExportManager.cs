        ...
        public virtual void ExportDTTongHopToXlsx(Stream stream, List<ListDoanhThuTongHop> DTTongHop, DateTime TuNgay, DateTime DenNgay)
        {
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                foreach (var item in DTTongHop)
                {
                    ...
                    worksheet.Cells[row, col].Value = item.DTNinhBinh.TongLuot;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTNinhBinh.SoKhach;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTNinhBinh.ThanhTien.ToString("###,###");
                    col++;

                    worksheet.Cells[row, col].Value = item.DTThaiBinh.TongLuot;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTThaiBinh.SoKhach;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTThaiBinh.ThanhTien.ToString("###,###");
                    col++;

                    worksheet.Cells[row, col].Value = item.DTNamDinh.TongLuot;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTNamDinh.SoKhach;
                    col++;
                    worksheet.Cells[row, col].Value = item.DTNamDinh.ThanhTien.ToString("###,###");
                    col++;

                   

                    decimal Tong = item.DTThaiBinh.ThanhTien + item.DTNamDinh.ThanhTien + item.DTNinhBinh.ThanhTien;
                ...
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTNinhBinh.TongLuot);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTNinhBinh.SoKhach);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTNinhBinh.ThanhTien).ToString("###,###");
                coltong++;

                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTThaiBinh.TongLuot);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTThaiBinh.SoKhach);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTThaiBinh.ThanhTien).ToString("###,###");
                coltong++;

                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTNamDinh.TongLuot);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTNamDinh.SoKhach);
                coltong++;
                worksheet.Cells[row, coltong].Value = DTTongHop.Sum(c => c.DTNamDinh.ThanhTien).ToString("###,###");
                coltong++;
