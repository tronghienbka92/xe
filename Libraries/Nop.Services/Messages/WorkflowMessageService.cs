...
namespace Nop.Services.Messages
{
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        private List<Token> CreateNewListToken(int StoreId)
        {
            var tokens = new List<Token>();
            var messageTemplate = GetActiveMessageTemplate("ChonVe.LienHe", StoreId);
            tokens.Add(new Token("ChonVe.LienHe", messageTemplate.Body,true));
            return tokens;
        }
        #endregion
        ...
        public virtual int SendCustomerRegisteredNotificationMessage(Customer customer, int languageId)
        {
            ...
            //tokens
            var tokens = CreateNewListToken(store.Id);
        ...
        public virtual int SendCustomerMessage(Customer customer, string templateid, int languageId)
        {
            if (customer == null)
                throw new ArgumentNullException("customer");
            ...
            var messageTemplate = GetActiveMessageTemplate(templateid, store.Id);
            if (messageTemplate == null)
                return 0;
